      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-0 md:m-auto md:max-w-5xl md:w-[calc(100%-4rem)] md:h-fit md:max-h-[90vh] bg-card rounded-3xl shadow-2xl z-50 overflow-hidden"
          >
            {/* Close button */}
            <button
              onClick={onClose}
